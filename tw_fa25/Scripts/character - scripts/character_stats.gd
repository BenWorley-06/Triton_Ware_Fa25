...
@export var wander_time: float = 5	#How long an idle character wanders in a choosen direction

@export var time_to_harvest: float = 5
@export var distance_to_harvest: float = 30

@export var breeding_distance: float = 20
@export var time_to_breed: float = 7


@export var murder_time: float = 2
